...
# LEG
# metrics_per_fold, x_test_parts, x_test_full, y_true, y_chance, y_predict, mean_fpr, mean_tpr, tprs_lower, tprs_upper, mean_auc, sd_auc, list_shap_values, list_test_sets, list_expected_values, list_features, stable_features, ale_data = fit_model(selected_data_leg, prefixes_leg, y_leg, participant_ids_leg, classifier='brf', n_splits=5, param_grids=param_grids,anova_k=anova_k_leg, threshold=threshold, not_per_muscle=not_per_muscle, scorers=scorers, refit_score=refit_score, resultfolder=resultfolder_sml+ r"\leg_model",plot=True)

# FOOT
metrics_per_fold, x_test_parts, x_test_full, y_true, y_chance, y_predict, mean_fpr, mean_tpr, tprs_lower, tprs_upper, mean_auc, sd_auc, list_shap_values, list_test_sets, list_expected_values, list_features, stable_features, ale_data = fit_model(selected_data_foot, prefixes_foot, y_foot, participant_ids_foot, classifier='brf', n_splits=5, param_grids=param_grids,anova_k=anova_k_foot, threshold=threshold, not_per_muscle=not_per_muscle, scorers=scorers, refit_score=refit_score, resultfolder=resultfolder_sml+r"\foot_model",plot=True)
